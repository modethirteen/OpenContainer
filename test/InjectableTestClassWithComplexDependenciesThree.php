...
class InjectableTestClassWithComplexDependenciesThree {

    private $DependencyOne;
    private $DependencyTwo;
    private $DependencyThree;
    private $DependencyFour;
    ...
    public function __construct(TestContainer $Container) {
        ...
        $this->DependencyThree = $Container->InjectableTestClassWithComplexDependenciesOne;
        $this->DependencyFour = $Container->InjectableTestClassWithComplexDependenciesTwo;
    }
}