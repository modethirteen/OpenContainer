...
class registerType_Test extends PHPUnit_Framework_TestCase {

    /**
     * @test
     */
    public function Can_register_type_by_injectable_class_with_no_dependencies_and_get_instance() {
        ...
        // act
        $Container->registerType('InjectableTestClassWithNoDependencies', $expectedInstanceClass);
     ...
     * @test
     */
    public function Can_register_type_by_injectable_class_with_dependencies_and_get_instance() {
        ...
        // act
        $Container->registerType('InjectableTestClassWithComplexDependenciesThree', $expectedInstanceClass);
     ...
     * @test
     */
    public function Can_register_type_with_closure_and_no_dependencies() {

        // arrange
        $Container = new TestContainer();

        // act
        $Container->registerType('NonInjectableClass', function() { return NonInjectableClass::newNonInjectableClass(); });
     ...
     * @test
     */
    public function Can_register_type_with_closure_and_dependencies() {
        ...
        // act
        $Container->registerType('NonInjectableClass', function(TestContainer $Container) {
